...
@push('page_scripts')
    <script>
        ...
        $('body').on('click', '.btnEdit', function () {
            ...
            window.open('/admin/card/state_edit/' + id, 'State', 'scrollbars=1, resizable=1, width=600, height=420');
            return false;
        });
        $('body').on('click', '.btnAdd', function () {
            window.open('/admin/card/state_edit/' + 0, 'State', 'scrollbars=1, resizable=1, width=600, height=420');
            return false;
        });
        ...
        $('body').on('click', '.btnDelete', function () {
            ...
            var id = $(this).attr('data-id');
            var action = '/admin/card/state_edit/' + id;
