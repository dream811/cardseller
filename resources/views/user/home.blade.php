    ...
    <div class="container-fluid">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p class="text-xs mb-1" style="">Card</p>
                <p class="text-xs" style="margin-bottom:5px;">Buy Amount</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p class="text-xs mb-1">Buy Amount</p>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p class="text-xs mb-1">New Users</p>
                <p class="text-xs mb-1">All Users</p>
              </div>
              <div class="icon">
        ...
        <div class="row">
          ...
          <section class="col-lg-6 connectedSortable">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="font-size:14px"><i class="fas fa-chart-pie mr-1"></i>Amount</h3>
