...
@push('page_scripts')
    <script>
        ...
        var table = $('#Table').DataTable({
            ...
            scrollY: "620px",
            ajax: {
                url: "{{ route('partner.cash.cash_list', $type) }}"
            },
            columns: [
        ...
        $('body').on('click', '.btnEdit', function () {
            ...
            window.open('/partner/user/userManage/edit/' + userId, '정보 수정', 'scrollbars=1, resizable=1, width=1000, height=620');
            return false;
        });
        $('body').on('click', '.btnAdd', function () {
            window.open('/partner/user/userManage/edit/0', '정보 추가', 'scrollbars=1, resizable=1, width=800, height=620');
            return false;
        });
