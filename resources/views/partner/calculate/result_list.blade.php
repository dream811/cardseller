    ...
    <script>
        ...
        var table = $('#tradingTable').DataTable({
            ...
            columns: [
                ...
                {title: "코인종목", data: 'coin_type', name: 'coin_type', className: "text-center"},
                {title: "매수가격", data: 'cur_price', name: 'cur_price', className: "text-center"},
                {title: "매수수량", data: 'coin_quantity', name: 'coin_quantity', className: "text-center"},
                {title: "총구매액", data: 'order_amount', name: 'order_amount', className: "text-center"},
                {title: "배당율", data: 'payout_rate', name: 'payout_rate', className: "text-center"},
                {title: "배당금", data: 'add_amount', name: 'add_amount', className: "text-center"},
                {title: "지급내역", data: 'payout_amount', name: 'payout_amount', className: "text-center"},
                {title: "지급시간", data: 'calculated_at', name: 'calculated_at',  className: "text-center"},
                {title: "지급상태", data: 'state_info', name: 'state_info', width: '140px', className: "text-center"},
            ],
